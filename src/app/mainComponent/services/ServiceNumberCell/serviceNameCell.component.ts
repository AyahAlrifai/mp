...
@Component({
    selector: 'service-name-cell',
    templateUrl: './serviceNameCell.component.html',
    styleUrls: ['./serviceNameCell.component.scss']
})
export class ServiceNameCell implements ICellRendererAngularComp {
    value: any = {};
