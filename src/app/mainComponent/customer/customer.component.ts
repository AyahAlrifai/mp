...
import { SearchFields } from '../../sharedComponent/search/search-fields';
import { SearchDataModle } from '../../sharedComponent/search/search.data.model';
...
export class CustomerComponent implements OnInit,OnDestroy  {
  ...
  constructor(private http: HttpClient, private headerService:HeaderService,private _snackBar: MatSnackBar, public customerService: CustomerService, public spinnerService: SpinnerService) {
  }
  ...
  private loadRequiredData(): void {
    ...
    this.headerService.updateHeader("<p>Customers</p>");
    forkJoin(
