...
import { ProductNameCell } from './ProductNameCell/productNameCell.component';
...
export class ProductsComponent implements OnInit, OnDestroy {
  ...
  constructor(private http: HttpClient, private headerService: HeaderService, private _snackBar: MatSnackBar, public productsService: ProductsService, public spinnerService: SpinnerService) {
  }
  ...
  private loadRequiredData(): void {
    ...
    forkJoin(
      this.http.get(`../../assets/configurations/default-products-column-def.json`),
      this.http.get(`../../assets/configurations/products-column-def.json`),
      this.http.get(`../../assets/configurations/products-grid-configuration-action.json`)
  ...
  private sendSearchRequest(): void {
    ...
    this.spinnerService.showSpinner();
    this.productsService.search(body).subscribe(data => {
